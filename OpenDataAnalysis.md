...
‘healthy control’ individuals from this large cross-sectional sample.
We attempted to do this in two ways. I) A very simple BDI symptom scale
...
to task performance. Optimal class breakdown (N=4 classes) is plotted
...
This approach identified 4 latent classes. Confirming our initial study,
...
onto the BDI and STAI , “ObsessiveCompulsive” which is a mix of the OCIR
and STAI (and not Schizotypy), and “Schizotypy” which loads positively
almost exclusively on the Schizotypy questionnaire.
...
Current diagnosis or treatment factors do not confound the primary
inference.
